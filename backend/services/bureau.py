"""MockBureauProvider — deterministic bureau snapshot for demo/testing."""
...
class MockBureauProvider:
    """Provide deterministic fake bureau data until a real bureau integration is wired."""

    @staticmethod
    def get_snapshot(customer: CustomerData) -> dict:
...
def get_bureau_snapshot(customer: CustomerData) -> dict:
    return MockBureauProvider.get_snapshot(customer)
