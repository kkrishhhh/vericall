...
export function CardStack<T extends CardStackItem>({
  ...
  React.useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      // Only intercept if the card stack is visible
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ background: "rgba(27,43,107,0.08)" }}
          aria-hidden="true"
        />
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    border: isActive ? "2px solid rgba(37,99,235,0.3)" : "2px solid rgba(255,255,255,0.06)",
                  }}
                  initial={
                    reduceMotion
                      ? false
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? "w-6" : "w-2 hover:opacity-70",
                  )}
                  style={{
                    background: on
                      ? "linear-gradient(135deg, #1B2B6B, #2563EB)"
                      : "var(--muted)",
                    opacity: on ? 1 : 0.3,
                  }}
